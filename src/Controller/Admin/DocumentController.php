...
class DocumentController extends AbstractController
{
    ...
    public function create(Request $request, MessageBusInterface $commandBus): Response
    {
        ...
        return $this->render(
            'admin/document/create.html.twig',
            [
    ...
    {
        return $this->render(
            'admin/document/detail.html.twig',
            [
                'document' => $document,
            ]
        );
    ...
    public function update(Request $request, Document $document, MessageBusInterface $commandBus): Response
    {
        ...
        return $this->render(
            'admin/document/update.html.twig',
            [
                'document' => $document,
                'form'     => $form->createView(),
            ]
    ...
    public function createVersion(Request $request, Document $document, MessageBusInterface $commandBus): Response
    {
        ...
        if ($this->handleForm($create, $form, $request, $commandBus)) {
            ...
            return $this->redirectToRoute('app_admin_document_detail', ['document' => $document->getSlug()]);
        }

        return $this->render(
            'admin/document/version_create.html.twig',
            [
                'document' => $document,
                'form'     => $form->createView(),
            ]
    ...
    {
        return $this->render(
            'admin/document/version_detail.html.twig',
            [
                'version' => $version,
            ]
        );
    ...
    public function updateVersion(Request $request, DocumentVersion $version, MessageBusInterface $commandBus): Response
    {
        ...
        if ($this->handleForm($update, $form, $request, $commandBus)) {
            ...
            return $this->redirectToRoute(
                'app_admin_document_detail',
                ['document' => $version->getDocument()->getSlug()]
            );
        }

        return $this->render(
            'admin/document/version_update.html.twig',
            [
                'version' => $version,
                'form'    => $form->createView(),
            ]
